...
public class PincodeCheck extends AbstractAnnotationCheck<PinCode> {
	...
	public boolean isSatisfied(Object validatedObject, Object valueToValidate,
		...
		if (valueToValidate != null
				&& !valueToValidate.toString().isEmpty()) {
			String pincode = valueToValidate.toString().trim();
			if (pincode.matches(PatternMatch.PINCODE_FORMAT)) {
				result = true;
			}
		}
		return result;
